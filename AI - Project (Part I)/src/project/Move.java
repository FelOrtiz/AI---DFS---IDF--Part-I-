...
public class Move implements Comparator
{
    ...
    public boolean equals(Object o)
    {
        if (o instanceof Move)
        {
            Move m = (Move) o;
            boolean same;
            if (m.getSrc() == null && src != null)
            {
                return false;
            }
            if (m.getDest() == null && dest != null)
            {
                return false;
            }
            if (m.getDest() != null && dest == null)
            ...
            if (((src == null && m.getSrc() == null && dest == null && m.getDest() == null) || (src.equals(m.getSrc()) && dest.equals(m.getDest()))) && shortcastle == m.getShortCastle() && longcastle == m.getLongCastle() && promotion == m.getPromotion())
            {
                return true;
            }
        }
